<?php
   ...
   $nivel = isset($_GET['niveis']) ? $_GET['niveis'] : 'Todos';
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
                    ...
                    <tbody>
                        <?php
                            if ($_SERVER['REQUEST_METHOD'] === 'GET') {
                                ...
                                if ($nivel == "Todos") {
                                    $select = "SELECT * FROM Usuarios WHERE Codigo LIKE :pesquisar OR Nome LIKE :pesquisar OR N_BI LIKE :pesquisar OR email LIKE :pesquisar";
                                } else {
                                    $select = "SELECT * FROM Usuarios WHERE Nivel = :nivel AND (Codigo LIKE :pesquisar OR Nome LIKE :pesquisar OR N_BI LIKE :pesquisar OR email LIKE :pesquisar)";
                                }
